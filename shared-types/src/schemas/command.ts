...
const BaseCommandDataSchema = z.object({
  ...
  categoryId: z.nativeEnum(CATEGORIES).nullable(),
...
export type CommandPermissionsUpdate = z.infer<
  typeof CommandPermissionsUpdateSchema
>;
export type DefaultCommandRegistration = z.infer<
  typeof DefaultCommandRegistrationSchema
>;
export type DefaultCommandRegistrationResponse = z.infer<
  typeof DefaultCommandRegistrationResponseSchema
>;
